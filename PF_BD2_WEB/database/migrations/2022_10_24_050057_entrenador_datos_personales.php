...
return new class extends Migration
{
    ...
    {
        //
        Schema::create('entrenadorDatosPersonales', function (Blueprint $table) {
            $table->increments('idEnetradaorDatosPersonales');
            $table->integer('cui');
    ...
    {
        //
        Schema::dropIfExists('entrenadorDatosPersonales');
    }
};
